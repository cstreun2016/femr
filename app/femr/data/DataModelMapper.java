...
public class DataModelMapper implements IDataModelMapper{
     ...
     */
    @Override
    public IPatient createPatient(int userID, String firstName, String lastName, Date birthday, Boolean isBirthCalculated, String sex, String address, String city, Integer photoID) {
        ...
        patient.setisBirthCalculated(isBirthCalculated);
        patient.setSex(sex);
