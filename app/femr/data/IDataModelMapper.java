...
public interface IDataModelMapper {
     ...
     */
    IPatient createPatient(int userID, String firstName, String lastName, Date birthday, Boolean isBirthCalculated, String sex, String address, String city, Integer photoID);
